...
local USERDATA_TAG = "hs._asm.uitk.element.textField.searchField"
local uitk         = require("hs._asm.uitk")
local module       = require(table.concat({ USERDATA_TAG:match("^([%w%._]+%.)[%w_]+%.([%w_]+)$") }, "libtextField_"))
...
module.recentMenuConstants = ls.makeConstantsTable(module.recentMenuConstants)
