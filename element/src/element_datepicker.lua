...
--- === hs._asm.uitk.element.datepicker ===
---
--- Stuff about the module

local USERDATA_TAG = "hs._asm.uitk.element.datepicker"
...
-- Public interface ------------------------------------------------------
module.calendarIdentifiers   = ls.makeConstantsTable(module.calendarIdentifiers)
module.timezoneAbbreviations = ls.makeConstantsTable(module.timezoneAbbreviations)
module.timezoneNames         = ls.makeConstantsTable(module.timezoneNames)
